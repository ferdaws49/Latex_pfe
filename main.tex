...
%\usepackage[french]{minitoc} % Moved down to fix warning W0030
...
\usepackage{chngcntr}
\usepackage{makecell}  % Fel préambulee pour les tableaux
...
\setlength{\parskip}{0pt} % Réglez la valeur selon vos préférences(9adeh el espaces bin les paragraphes)
%-------------------
...
\usepackage[french]{minitoc} % Moved here to be after hyperref and fncychap
\dominitoc % Create mini-toc for each chapter
\makeatletter
\renewcommand{\numberline}[1]{%
...
\input{project/Dédicaces}
\clearpage
\input{project/remerciements}
\clearpage
\input{project/Résumé}
\clearpage
...
\tableofcontents% 9otlou assna3li sommaire globale
 ...
 \input{project/Acronymes}
 \clearpage
 \pagenumbering{arabic}
\input{project/introduction}
\input{project/chapitre1}
\input{project/chapitre2}
\input{project/chapitre3}
\input{project/chapitre4}
\input{project/chapitre5}
\input{project/chapitre6}
