...
intégrés (régression logistique pour la détection des risques d'abandon, Prophet pour les
prévisions d'inscriptions) ont affiché des performances satisfaisantes, avec une précision
globale de \textbf{83\%} et un AUC-ROC de \textbf{0,88}. Le recours à LLaMA~3 pour la
