...
\hline
Module IA &  Fournit des analyses prédictives et recommandations stratégiques pour anticiper les risques, optimiser la planification et soutenir la prise de décision des acteurs métier.  \\
\hline
\end{tabular}
\end{table}
\subsection{Spécifications des besoins fonctionnels}
Cette section présente les besoins fonctionnels de la plateforme en fonction des différents acteurs, en mettant en évidence les fonctionnalités attendues pour chaque utilisateur. 

\vspace{0.3cm}
\noindent\textbf{Besoins fonctionnels de l’acteur « Directeur »}


\noindent Le tableau \ref{tab:Besoins fonctionnels de l’acteur « Directeur »} présente les besoins du Directeur, orientés vers l’analyse stratégique de l'établissement.
\begin{table}[H]
\centering
...
\noindent\textbf{Besoins fonctionnels de l’acteur « Responsable pédagogique »}

\noindent Le tableau \ref{tab:Besoins fonctionnels de l’acteur « Responsable pédagogique »} présente les besoins du Responsable Pédagogique.
...
\noindent\textbf{Besoins fonctionnels de l’acteur «Responsable financier »}

\noindent Le tableau \ref{tab:Besoins fonctionnels de l’acteur « Responsable financier »} présente les besoins du Responsable Financier.
\begin{table}[H]
\centering
...
\noindent \textbf{Besoins fonctionnels de l’acteur « Administrateur système »}

\noindent Le tableau \ref{tab:Besoins fonctionnels de l’acteur « Administrateur »} présente les besoins de l’Administrateur, centrés sur la gestion des utilisateurs et la maintenance technique du système. 
\begin{table}[H]
\centering
...
\noindent\textbf{Besoins fonctionnels de l'Apprenant}

\vspace{0.3cm}


\noindent Le tableau \ref{tab:Besoins fonctionnels de l’acteur « Apprenant »} présente les besoins de l’Apprenant. Bien que la plateforme soit principalement orientée décisionnel pour les responsables, l’intégration d’un espace apprenant permet d’améliorer l’engagement, la transparence et le suivi individuel des performances.
...
\noindent\textbf{Besoins fonctionnels du module IA}

\vspace{0.3cm}


\noindent Le tableau \ref{tab:Besoins fonctionnels de l’acteur « Module IA »} synthétise les besoins fonctionnels du module Intelligence Artificielle, associant chaque fonctionnalité prédictive à son acteur métier, sa description et ses flux de données.
...
Alertes sur risques d'abandon &
Analyse prédictive des profils apprenants pour détecter les risques d'abandon et notifier le responsable pédagogique en temps utile.\\
\hline

Prévision des revenus &
Projection budgétaire basée sur l'historique financier et les tendances d'inscription pour accompagner la planification du responsable financier.\\
\hline

Prévision des inscriptions &
Estimation du volume futur des inscriptions pour permettre au directeur d'anticiper les besoins en ressources.\\
\hline

Prédiction des sessions déficitaires &
Prédit les sessions susceptibles d’être déficitaires. Cette analyse permet au responsable financier d’anticiper les pertes et de prendre des décisions financières plus éclairées.\\
\hline

Recommandations stratégiques &
Synthèse intelligente des données multi-sources pour proposer au directeur des actions prioritaires et améliorer la performance globale.\\
\hline
...
\begin{figure}[H]
  \centering
    \includegraphics[scale=0.4]{project/images/bhbhbh.png}
...
\begin{itemize}[label=\textbullet]
  ...
  \item \textbf{Development Team }: Mariem khlifi, ferdaws maraach
\end{itemize}
...
\begin{longtable}{|>{\centering\arraybackslash}p{1cm}|>{\centering\arraybackslash}p{4cm}|p{10cm}|>{\centering\arraybackslash}p{1.5cm}|}
...
\multirow{3}{=}{\centering\textbf{1}} & \multirow{3}{=}{\centering\textbf{Authentification}}
...
\multirow{3}{=}{\centering\textbf{2}} & \multirow{3}{=}{\centering\textbf{Gestion des utilisateurs}}
...
\multirow{1}{=}{\centering\textbf{3}} & \multirow{1}{=}{\centering\textbf{\shortstack{Gestion des sessions \\ de formation}}}
...
\multirow{11}{=}{\centering\textbf{4}} & \multirow{11}{=}{\centering\textbf{Espace apprenant}}
...
\multirow{4}{=}{\centering\textbf{5}} & \multirow{4}{=}{\centering\textbf{\shortstack{Alimentation \\ des données}}}
...
\multirow{6}{=}{\centering\textbf{6}} & \multirow{6}{=}{\centering\textbf{\shortstack{Visualisation et \\ analyse des données}}}
& En tant qu'utilisateur interne, je veux analyser les données du centre afin de comprendre les performances des activités. & M \\
\cline{3-4}
...
\multirow{5}{=}{\centering\textbf{7}} & \multirow{5}{=}{\centering\textbf{\shortstack{Module prédictif \\ et recommandations}}}
