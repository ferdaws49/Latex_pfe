...
\hline
Administrateur Système &Assure l’administration globale du système, ainsi que la gestion des utilisateurs et des ressources. Il garantit la sécurité, la fiabilité et la cohérence des données. \\
\hline
...
\textbf{Besoins fonctionnels de l’acteur «financier »}
...
\cline{3-4}
& & En tant que responsable financier, je veux consulter un dashboard opérationnel pour suivre les activités quotidiennes. & M \\ 
\cline{3-4}
...
\cline{3-4}
& & En tant que responsable financier, je veux analyser les données financières pour suivre les recettes et les dépenses. & M\\ 
\cline{3-4}
...
& En tant que utilisateur, je veux appliquer des filtres (période, formation…), afin d’affiner l’analyse & M \\ 

\hline

% --- US05 ---
\multirow{2}{*}{\textbf{6}} & \multirow{2}{*}{\textbf{Reporting\& Export}} 
& En tant que responsable financier, je veux générer et exporter des rapports pour documenter les activités & M \\ 
\cline{3-4}
& & En tant que directeur, je veux Exporter des rapports pour partager les analyses stratégiques & M \\ 
\hline
\multirow{4}{*}{\textbf{7}} & \multirow{4}{*}{\textbf{Gestion des Formations}} 
& En tant que responsable pédagogique, je veux gérer les sessions de formation et le planning pour éviter les conflits & M \\ 
\cline{3-4}
& & En tant que responsable pédagogique , je veux Affecter des formateurs aux sessions et consulter la liste des participants & M\\ 
\cline{3-4}
...
Le tableau \ref{tab:release_planning} présente la répartition détaillée de notre planification des sprints, en soulignant:
...
\hline
\multirow{3}{*}{Release 2} & 3& Gestion multi-domaines (pédagogique, financier, administratif) & 14 \\
\cline{2-4}
