...
\begin{figure}[H]
  \centering
    \includegraphics[scale=0.8]{project/images/diagramme globale.png}
...
% --- US03 : Intégration des données ---
\multirow{4}{*}{\textbf{3}} & \multirow{4}{*}{\textbf{Intégration des données}}
...
\cline{3-4}
& & En tant que responsable financier, je veux gérer les activités financières du centre afin de suivre sa santé financière. & M \\
\cline{3-4}
& & En tant qu'apprenant, je veux gérer mon parcours de formation afin de rester informé de ma progression. & S \\
\hline

% --- US05 : Analyse & KPIs ---
\multirow{4}{*}{\textbf{5}} & \multirow{4}{*}{\textbf{Analyse \& KPIs}}
...
\cline{3-4}
& & En tant que directeur, je veux visualiser les KPIs stratégiques et analyser les performances globales du centre. & M \\
\cline{3-4}
& & En tant qu'utilisateur, je veux appliquer des filtres (période, formation, formateur...) afin d'affiner mon analyse. & M \\
\hline

% --- US06 : Modèles prédictifs (IA) ---
\multirow{3}{*}{\textbf{6}} & \multirow{3}{*}{\textbf{Modèles prédictifs (IA)}}
...
% --- US07 : Notifications & Alertes ---
\multirow{1}{*}{\textbf{7}} & \multirow{1}{*}{\textbf{Notifications \& Alertes}}
...
% --- US08 : Dashboards ---
\multirow{4}{*}{\textbf{8}} & \multirow{4}{*}{\textbf{Dashboards}}
...
% --- US09 : Export & Reporting ---
\multirow{2}{*}{\textbf{9}} & \multirow{2}{*}{\textbf{Export \& Reporting}}
& En tant que responsable financier, je veux générer et exporter des rapports pour documenter les activités du centre. & M \\
\cline{3-4}
...
& 3 & Intégration des données (ETL) & 10 \\
\cline{2-4}
& 4 & Gestion multi-domaines (pédagogique, financier, administratif..) & 10 \\
\hline

\multirow{1}{*}{Release 3} 
& 5 & Analyse - KPIs + Filtrage avancé & 10 \\
\hline

\multirow{2}{*}{Release 4} 
& 6 & Modèles prédictifs (IA) & 10 \\
\cline{2-4}
& 7 & Notifications et alertes intelligentes & 10 \\
\hline

\multirow{2}{*}{Release 5} 
& 8 & Dashboard (visualisation des données) & 10 \\
\cline{2-4}
& 9 & Reporting et export des données & 10 \\
\hline
