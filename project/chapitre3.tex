...
\begin{minipage}{0.55\textwidth}
\raggedright
\textbf{Supabase :} \cite{supabase_docs} est une plateforme open source de type Backend-as-a-Service (BaaS), permettant de fournir des services backend prêts à l’emploi tels que la gestion de base de données, l’authentification et les API. Elle facilite le développement d’applications en réduisant la complexité liée à la mise en place d’une infrastructure backend (voir figure \ref{fig:supabase_logo}).
\end{minipage}
\hfill
 \begin{minipage}{0.3\textwidth}
        \centering
        \includegraphics[width=0.7\textwidth]{project/images/supabase_logo.jpg}
...
\begin{minipage}{0.55\textwidth}
\raggedright
\textbf{FastAPI :} \cite{Fastapi_docs} FastAPI est un framework web moderne pour Python (voir figure \ref{fig:fastapi_logo}), permettant de créer des API rapidement et de manière performante. Il repose sur les annotations de type Python et facilite la validation des données ainsi que la génération automatique de la documentation interactive des API.
\end{minipage}
\hfill
 \begin{minipage}{0.3\textwidth}
        \centering
        \includegraphics[width=0.7\textwidth]{project/images/Fastapi.png}

 \captionof{figure}{Logo FastAPI}
...
La figure \ref{fig:placeholder} illustre l'architecture générale retenue, laquelle est structurée en trois parties principales. \newline

\begin{figure}[H]
     \centering
     \includegraphics[width=1\linewidth]{project/images/Gemini_Generated_Image_jsvpksjsvpksjsvp.png}
     \caption{architecture generale}
     \label{fig:placeholder}
 \end{figure}
 \vspace{0.8cm}
 
\noindent\textbf{Tier 1 : Couche de Présentation (Front-end)}\newline
Il représente les interfaces de l'application, c'est-à-dire les éléments avec lesquels l'utilisateur peut interagir. \newline

\vspace{0.3cm}

\noindent\textbf{Tier 2 : Couche Application (Back-end)}\newline
...
\noindent\textbf{Couche persistence:} Utilise un ORM (Object-Relational Mapping) pour faire le pont entre le code et la base de données, assurant une manipulation fluide des Entities.\newline

\noindent\textbf{Tier 3 : Couche de Données (Database)}\newline
...
Cette section détaille la conception technique du système selon deux axes complémentaires : l'architecture applicative et la modélisation multidimensionnelle des données.
...
\noindent La figure \ref{fig:diagramme de classe} présente cette modélisation et illustre comment les différentes classes interagissent pour assurer le fonctionnement cohérent de la plateforme.

\begin{figure}[H]
  \centering
    \includegraphics[scale=0.4]{project/images/hLRBRjim4BmRy3-eERL5OxJN78gujjAgG5F3SN8r66dj4AL8bQJI14K_gD_H7-kIr8EKnJo0N19nj1hEpYwNFbMQI5sNB5anec4dP0dRJzascsyNegmOQ9XENkaRA26f6A5yEfbEWDTbad6LIrffAlY59hhMoU_f94dEls-sL-awEylIfLclqlDbTlxPFCuNYtIrSV0w_PekxFEVZl5IWL.png}
...
\begin{figure}[H]
     \centering
     \includegraphics[width=0.7\linewidth]{project/images/Capture d’écran 2026-03-23 234150.png}
 ...
 \begin{figure}[H]
     \centering
     \includegraphics[width=0.7\linewidth]{project/images/Capture d’écran 2026-03-23 232928.png}
