...
\begin{figure}[H]
  \centering
    \includegraphics[scale=0.4]{project/images/diagrammedeclasse.png}
  \caption{ Diagramme de classe}
  \label{fig:diagramme de classe}
\end{figure}

\subsection{Modélisation décisionnelle}
La modélisation décisionnelle est l'étape clé qui permet de transformer les données brutes de gestion en informations exploitables pour le pilotage de l'activité. Pour ce projet, nous avons mis en place un Système d’Information Décisionnel (SID) basé sur une architecture ROLAP.

\textbf{Architecture en Schéma en Étoile (Star Schema)}

Le cœur de notre modélisation repose sur un \textbf{Schéma en Étoile}. Cette structure est ainsi nommée car elle organise les données de manière centrale et rayonnante:
