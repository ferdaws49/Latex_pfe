...
Dans la continuité de notre démarche, nous consacrons la section \ref{sec:Analyse de l'existant} à l'analyse de l'existant, où nous mettons en lumière les études déjà réalisées ainsi que les critiques qui en découlent. Cette analyse nous permet d'introduire, dans la section \ref{sec:Solution proposée}, la solution que nous préconisons, avant d'en établir une comparaison avec les solutions déjà disponibles sur le marché dans la section \ref{sec:Comparaison avec les solutions existantes}. Enfin, nous clôturons ce chapitre par la section \ref{sec:Méthodologie de travail }, dédiée à la justification de la méthodologie de travail adoptée pour ce projet ainsi qu'au détail de son déroulement.
...
Le tableau \ref{tab:comparaison} suivant récapitule les failles majeures identifiées dans les solutions existantes, selon certains critères clés :
