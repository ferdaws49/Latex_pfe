...
\noindent Par ailleurs, l’absence d’intégration entre ces différentes solutions engendre une fragmentation des données, rendant difficile la consolidation et l’exploitation cohérente des informations.
...
\noindent Le tableau \ref{tab:comparaison} récapitule les failles majeures identifiées dans les solutions existantes, selon certains critères clés :
...
la plateforme se distingue par les avantages presentés dans le tableau \ref{tab:avantages}.
\begin{table}[H]
\centering
...
\hline
IA prédictive & Modèles de Machine Learning pour anticiper les tendances et les performances futures. \\
\hline
