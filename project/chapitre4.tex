...
\end{table}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{project/images/inscription_use_case.png}
...
La figure \ref{fig:usecase_password_modification} présente le diagramme de cas d’utilisation expliquant le fonctionnement de la modification du mot de passe.
 \begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{project/images/usecase_reset.png}
