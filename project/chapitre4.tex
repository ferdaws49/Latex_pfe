...
\end{table}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{project/images/efe.png}
...
L’utilisateur a accès à son email\\

\hline
Scénario de base & 
\textbf{Scénario 1 : Inscription} \\
& L’utilisateur saisit ses informations (nom, prenom, email, téléphone, mot de passe, confirmation, programme). \\
...
Le compte est en statut \textit{En attente de validation}.
...
\hline
Préconditions & 
 L'utilisateur possède un compte vérifié et approuvé dans le système
...
\noindent La figure \ref{fig:usecase_password_modification} présente le diagramme de cas d’utilisation expliquant le fonctionnement de la modification du mot de passe.
 \begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{project/images/zef.png}
...
&- Le système vérifie la validité de l'email. \\
&- Le système vérifie l'existence de l'email en base. \\
&- Le système envoie un lien de réinitialisation unique et temporaire. \\
&- Le système affiche un message de confirmation. \\
\\
& \textbf{Scénario 2 : Réinitialisation du mot de passe} \\
&- L'utilisateur ouvre le lien reçu par email. \\
&- Il saisit le nouveau mot de passe et sa confirmation. \\
&- Le système vérifie que les champs sont remplis. \\
&- Le système vérifie que les mots de passe sont identiques. \\
&- Le système vérifie la validité du lien (token non expiré). \\
&- Le système met à jour le mot de passe (hash). \\
&- Le système affiche un message de succès et redirige vers login. \\
\hline

Scénarios alternatifs &
\textbf{Email invalide ou vide :} Le système affiche un message d'erreur et bloque l'envoi. \\
& \textbf{Email inexistant :} Affichage d'un message générique pour des raisons de sécurité. \\
& \textbf{Mots de passe non identiques :} Le système rejette la demande. \\
& \textbf{Lien expiré ou déjà utilisé :} Le système affiche une erreur et demande une nouvelle réinitialisation. \\
\hline

Post-conditions &
Un lien de réinitialisation est généré. \\
& Un email est envoyé à l'utilisateur. \\
& L'utilisateur accède au formulaire de réinitialisation. \\
