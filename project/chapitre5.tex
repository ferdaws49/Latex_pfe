...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{project/images/seqdiagram_import.png}
...
\begin{table}[H]
\centering
\caption{Backlog du Sprint 4: Gestion multi-domaines}
\label{tab:sprint3_backlog}
\begin{tabular}{|c|p{4.4cm}|p{10cm}|c|}
\hline
\textbf{ID} & \textbf{Fonctionnalité} & \textbf{User Story} & \textbf{Priorité} \\
\hline
\multirow{4}{*}{\textbf{4}} & \multirow{4}{*}{\textbf{Gestion multi-domaines}}
& En tant que responsable pédagogique, je veux gérer les activités pédagogiques du centre afin d'assurer le bon déroulement des formations. & M \\
...
La figure \ref{Diagramme de cas d'utilisation « planning »} illustre le diagramme de cas d'utilisation présentant les différentes interactions entre l'administrateur et le système lors du processus d'import.

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{project/images/UC-RP(planning).png}
    \caption{Diagramme de cas d'utilisation « planning »}
    \label{Diagramme de cas d'utilisation « Gestion et Planification des Sessions de Formation »}
\end{figure}
...
\textbf{Diagramme de séquence: creer session}
